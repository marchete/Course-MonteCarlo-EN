...
int main()
{
  UnionType unionOperation = UnionType::SUBTRACTION;
  ...
  vector<Shape*> shapes;
  shapes.push_back(new Circle(100,100,80)); //Main shape
//Substract all those
  shapes.push_back(new Circle(30,100,27)); 
  shapes.push_back(new Circle(100,45,42));  
  shapes.push_back(new Rectangle(1,160,120,35));    
  shapes.push_back(new Rectangle(100,100,20,35));    
  shapes.push_back(new Rectangle(60,170,90,20));    
