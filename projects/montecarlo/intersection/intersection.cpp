...
int main()
{
  UnionType unionOperation = UnionType::INTERSECTION;
  ...
  vector<Shape*> shapes;
  shapes.push_back(new Circle(100,66,60));
  shapes.push_back(new Circle(66,120,63));
  shapes.push_back(new Circle(130,130,65));  
